...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
                        ...
                        if (response.isSuccessful()) {
                            for (int i = 0; i < response.body().getResults().length; i++) {
                                ...
                                if (placeType.equals("police"))
                                    ...
                                    markerOptions.icon(BitmapDescriptorFactory.fromResource(R.drawable.q));
                                else if (placeType.equals("bus_station"))
                                    markerOptions.icon(BitmapDescriptorFactory.fromResource(R.drawable.bst));
                                else if (placeType.equals("hospital"))
                                    markerOptions.icon(BitmapDescriptorFactory.fromResource(R.drawable.hsp));
                                else
    ...
    public void onLocationChanged(android.location.Location location) {
        ...
        MarkerOptions markerOptions = new MarkerOptions()
                .position(latLng)
                .title("Ini Lokasi Kamu Sekarang")
